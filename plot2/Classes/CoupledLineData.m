                ...
                for SetPower = unique(obj.data.SetPower)'
                    for bias = 1:size(bins,2)-1
                        ...
                        if ~isnan(Sampler2_Range)
                            ...
                            RMSError, GoodnessOfFit, Sampler1_phase, Sampler2_phase, GoodnessOfFitPhase] = obj.samplerfitting(T.GammaLoad,T.Sampler1_V,T.Sampler2_V);
           
                        else
                            ScaleFactorOffset = nan;
                            ScaleFactorSampler1_Av = nan;ScaleFactorSampler2_Av= nan;
                            RMSError= nan; GoodnessOfFit= nan; Sampler1_phase= nan; Sampler2_phase= nan; GoodnessOfFitPhase= nan;
                        end

classdef DataTableClass
    ...
    methods
                ...
                for SetPower = obj.power_list
                    for bias = 1:size(bins,2)-1
                        ...
                        if ~isnan(Sampler2_Range)
                            ...
                            RMSError, GoodnessOfFit, Sampler1_phase, Sampler2_phase, GoodnessOfFitPhase, MaxError] = ...
                            ...
                            obj.freqpowerbiastable = [obj.freqpowerbiastable; table(ScaleFactorOffset,...
                                    ScaleFactorSampler1_Av,ScaleFactorSampler2_Av,...
                                    RMSError, MaxError, GoodnessOfFit, Sampler1_phase, Sampler2_phase, GoodnessOfFitPhase, ...
        ...
        function [ScaleFactorOffset,...
                ScaleFactorSampler1_Av,ScaleFactorSampler2_Av,...
                RMSError, GoodnessOfFit, Sampler1_phase, Sampler2_phase, GoodnessOfFitPhase, MaxError]  = samplerfitting(obj,x,v1,v2)
            ...
            RMSError = rmse(abs(x),sqrt(ScaleFactor(2)*v1+ScaleFactor(3)*v2 +...
                 ScaleFactor(4)));
            MaxError = max(max(abs(x)-abs(sqrt(ScaleFactor(2)*v1+ScaleFactor(3)*v2 +...
                 ScaleFactor(4)))));
        end

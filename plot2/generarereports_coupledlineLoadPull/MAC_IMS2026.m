...
topLevelFolder = '/Users/gracegomez/Documents/Research Code Python/summer2025_loadpull_repo/data/PA_Spring2023/'
files = dir(topLevelFolder);
dirFlags = [files.isdir];
subFolders = files(dirFlags);
subFolderNames = {subFolders(3:end).name};

LUTfolder = '/Users/gracegomez/Documents/Research Code Python/summer2025_loadpull_repo/data/LUT3';
...
for i = 2
    ...
    for pow = unique(biasTable.SetPower)' 
        ...
        plot(T.frequency,T.RMSError,'DisplayName',sprintf('Bias %.2f, Power %f',mean(T.SamplerV_Mean),pow))

...
for k = 1 : size(folder,1)
    ...
    mkdir(strcat('C:\Users\grgo8200\Documents\AFRL_Testbench\data\deembed\',folder(k,:)));
    save(strcat('C:\Users\grgo8200\Documents\AFRL_Testbench\data\deembed\',folder(k,:),'\pna2pm_input.mat'), 'pna2pm_input'); 
    save(strcat('C:\Users\grgo8200\Documents\AFRL_Testbench\data\deembed\',folder(k,:),'\pna2pm_output.mat'), 'pna2pm_output');
    save(strcat('C:\Users\grgo8200\Documents\AFRL_Testbench\data\deembed\',folder(k,:),'\pm.mat'), 'pm');
    save(strcat('C:\Users\grgo8200\Documents\AFRL_Testbench\data\deembed\',folder(k,:),'\obw.mat'), 'obw');
    save(strcat('C:\Users\grgo8200\Documents\AFRL_Testbench\data\deembed\',folder(k,:),'\iaw.mat'), 'iaw');
    save(strcat('C:\Users\grgo8200\Documents\AFRL_Testbench\data\deembed\',folder(k,:),'\oaw.mat'), 'oaw');
    save(strcat('C:\Users\grgo8200\Documents\AFRL_Testbench\data\deembed\',folder(k,:),'\ibw.mat'), 'ibw');

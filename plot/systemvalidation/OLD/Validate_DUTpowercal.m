...
dname = '../../data/systemvalidation/2025-07-14_09_42_Freq12.0to8.0';
...
pna2pm_input = load(strcat('../../data/deembed/','2025-07-11_12_28_Freq12.0to8.0','/pna2pm_input.mat')).pna2pm_input;
pna2pm_output = load(strcat('../../data/deembed/','2025-07-11_12_28_Freq12.0to8.0','/pna2pm_output.mat')).pna2pm_output;validation07091618_inputpowerdBm = load('./validation07091618').validation07091618_inputpowerdBm;
